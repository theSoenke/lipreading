...
for seed in {0..30}; do
    ...
    python3 train_words.py --data $data --words 10 --seed $seed --batch_size $batch_size
    ...
    for query in "-90,-20" "-20,20" "20,90"; do
        ...
        python3 train_words.py --data $data --words 10 --seed $seed --query " ${query}" --checkpoint data/checkpoints/lrw/best_seed_${seed}.pkl --batch_size $batch_size
